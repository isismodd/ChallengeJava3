...
public class LembreteWebController {
    ...
    public String listar(Model model) {
        model.addAttribute("lembretes", lembreteService.listarTodos());
        model.addAttribute("pendentes", lembreteService.buscarPendentes());  // ← Adicionar pendentes
        return "lembretes/lista";
    }

    @GetMapping("/pendentes")
    public String listarPendentes(Model model) {
        var pendentes = lembreteService.buscarPendentes();
        model.addAttribute("lembretes", pendentes);
        model.addAttribute("pendentes", pendentes);
        return "lembretes/lista";
    }

    @GetMapping("/enviar/{consultaId}")
    public String enviarLembrete(@PathVariable Long consultaId) {
        lembreteService.criarEEnviarLembrete(consultaId);
